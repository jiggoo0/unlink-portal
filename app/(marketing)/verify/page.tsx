  ...
  return (
    <main className="relative min-h-screen pt-32 pb-24 overflow-hidden">
      ...
      <div className="container relative z-10 px-6 mx-auto max-w-5xl">
        ...
        <div className="max-w-3xl mx-auto">
          <div className="bg-secondary/20 border border-border/40 p-2 rounded-[2.5rem] shadow-2xl backdrop-blur-xl mb-12 group focus-within:border-primary/30 transition-all">
            <div className="flex flex-col md:flex-row gap-2">
              <div className="flex-1 relative">
                ...
                <Input 
                  placeholder="กรอก ID ใบรับรอง หรือรหัสตรวจสอบ (e.g. UL-C-001)..." 
                  className="h-16 pl-16 pr-8 bg-transparent border-0 text-lg font-bold placeholder:text-muted-foreground/30 focus-visible:ring-0"
                />
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white/5 border border-white/5 p-8 rounded-[2rem] space-y-4 group hover:bg-white/10 transition-all cursor-default">
              ...
              <h3 className="text-xs font-black uppercase tracking-widest text-foreground italic">Valid Status</h3>
              <p className="text-[11px] text-muted-foreground font-medium leading-relaxed">
                เอกสารและตัวตนที่ผ่านการรับรองแล้วจะขึ้นสถานะสีเขียว พร้อมรายละเอียดการตรวจสอบ
              </p>
            </div>
            ...
            <div className="bg-white/5 border border-white/5 p-8 rounded-[2rem] space-y-4 group hover:bg-white/10 transition-all cursor-default">
              ...
              <h3 className="text-xs font-black uppercase tracking-widest text-foreground italic">Under Review</h3>
              <p className="text-[11px] text-muted-foreground font-medium leading-relaxed">
            ...
            <div className="bg-white/5 border border-white/5 p-8 rounded-[2rem] space-y-4 group hover:bg-white/10 transition-all cursor-default">
              ...
              <h3 className="text-xs font-black uppercase tracking-widest text-foreground italic">Revoked / Alert</h3>
              <p className="text-[11px] text-muted-foreground font-medium leading-relaxed">
        ...
        {/* --- 🔒 SECURITY PROTOCOL --- */}
        <div className="mt-24 pt-12 border-t border-border/40 flex flex-col md:flex-row items-center justify-between gap-8 opacity-50 grayscale hover:opacity-100 hover:grayscale-0 transition-all">
          ...
          <div className="flex gap-8">
            ...
            <div className="flex items-center gap-2">
              <ShieldCheck className="h-4 w-4 text-primary" />
              <span className="text-[9px] font-black uppercase tracking-widest">AA Accredited</span>
            </div>
          </div>
        </div>
      </div>
